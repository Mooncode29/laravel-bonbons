...
axios.get('/api/bonbons').then(function (response) {
  var len = response.data.length;
  for (var i = 0; i < len; i++) {
    var bonbon = response.data[i];
    $('#app').append('<tr>' + '<td>' + response.data[i].id + '</td>' + '<td>' + response.data[i].name + '</td>' + '<td>' + response.data[i].quantity + '</td>' + '</tr>');
  }
